...
const tour = driver({
  ...
  steps: [
    ...
    {
      popover: {
        title: 'Built for ASME Ventures',
        description: `
          <div style="margin-bottom: 12px;">
            This prototype's AI evaluation model was strictly calibrated to align with ASME Ventures' explicit areas of focus as outlined on your website:
          </div>
          <div style="display: grid; grid-template-columns: 1fr; gap: 8px; margin-bottom: 16px;">
            <div style="background: rgba(255,255,255,0.03); border: 1px solid var(--border-color); padding: 8px 12px; border-radius: 6px; font-size: 13px; font-weight: 500; display: flex; align-items: center; gap: 8px;">
               <span style="color: var(--accent); font-weight: 700;">01</span> Digital Solutions
            </div>
            <div style="background: rgba(255,255,255,0.03); border: 1px solid var(--border-color); padding: 8px 12px; border-radius: 6px; font-size: 13px; font-weight: 500; display: flex; align-items: center; gap: 8px;">
               <span style="color: var(--accent); font-weight: 700;">02</span> Intelligent Automation
            </div>
            <div style="background: rgba(255,255,255,0.03); border: 1px solid var(--border-color); padding: 8px 12px; border-radius: 6px; font-size: 13px; font-weight: 500; display: flex; align-items: center; gap: 8px;">
               <span style="color: var(--accent); font-weight: 700;">03</span> Hardware Design & Operations
            </div>
            <div style="background: rgba(255,255,255,0.03); border: 1px solid var(--border-color); padding: 8px 12px; border-radius: 6px; font-size: 13px; font-weight: 500; display: flex; align-items: center; gap: 8px;">
               <span style="color: var(--accent); font-weight: 700;">04</span> Advanced Energy & Storage
            </div>
            <div style="background: rgba(255,255,255,0.03); border: 1px solid var(--border-color); padding: 8px 12px; border-radius: 6px; font-size: 13px; font-weight: 500; display: flex; align-items: center; gap: 8px;">
               <span style="color: var(--accent); font-weight: 700;">05</span> Next-Gen Safety Tech
            </div>
          </div>
          <div style="font-size: 13px; color: var(--text-muted); font-style: italic;">
            Every AI analysis generated by this platform strictly judges candidates against these exact parameters to ensure high-fidelity screening.
          </div>
        `,
        side: "over",
        align: 'center'
